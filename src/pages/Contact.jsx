...
function Contact() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-10 lg:py-20">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="text-center">
            ...
            <p className="text-xs font-bold uppercase tracking-[3px] text-[#A85D35]">
              Get In Touch
            </p>

            <h2 className="mt-3 text-3xl font-extrabold text-[#171717] sm:text-4xl">
              We'd Love To{" "}
              <span className="text-[#A85D35]">
                Hear From You
              </span>
          ...
          <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {/* Visit Us */}
            <div className="rounded-2xl border border-gray-100 bg-[#faf8f6] p-6 text-center transition duration-300 hover:-translate-y-1 hover:shadow-md">
      ...
      {/* ================= MESSAGE SECTION ================= */}
      <section className="bg-[#fbf9f7] px-4 py-12 sm:px-6 sm:py-16 lg:px-10 lg:py-20">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          {/* Form */}
          <form className="mt-9 rounded-3xl bg-white p-5 shadow-sm ring-1 ring-[#eee5df] sm:p-8 lg:p-10">
            ...
            <div className="grid gap-5 md:grid-cols-2">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 bg-[#fcfbfa] px-4 py-3.5 text-sm outline-none transition focus:border-[#A85D35] focus:ring-1 focus:ring-[#A85D35]/20"
                />
              </div>
            ...
            <div className="mt-5">
              ...
              <textarea
                ...
                className="w-full resize-none rounded-xl border border-gray-200 bg-[#fcfbfa] px-4 py-3.5 text-sm outline-none transition focus:border-[#A85D35] focus:ring-1 focus:ring-[#A85D35]/20"
              ></textarea>
            ...
            <button
              type="submit"
              className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#A85D35] px-7 py-3.5 text-sm font-semibold text-white transition duration-300 hover:bg-[#8f4e2e]"
            >
              Send Message
              <FiSend size={16} />
            </button>
      ...
      <section className="px-4 py-12 sm:px-6 sm:py-16 lg:px-10 lg:py-20">
        ...
        <div className="mx-auto max-w-7xl rounded-[30px] bg-[#A85D35] px-6 py-10 text-center sm:px-10">
          ...
          <a
            ...
            className="mt-7 inline-flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-sm font-semibold text-[#A85D35] transition hover:bg-[#faf5f1]"
          >
            <FiMail size={16} />
            Email Us
          </a>
